...
cnn_out_channels = 8
cnn_pool_size = 8
cnn_dense_in_features = 16 * cnn_out_channels
...
model_params = NeuralNet.get_params(model)
...
for epoch in 1:epochs
    ...
    t_epoch = @elapsed begin
        for i in 1:num_batches
            ...
            loss_var = LossFunctions.binary_cross_entropy(y_pred_var, y_true_for_loss)
    ...
    test_loss_var = LossFunctions.binary_cross_entropy(y_test_pred_var, y_test_for_loss)
